    ...
    tools: [
      {
        ...
        slug: 'compress-image',
        name: 'Compress Image',
        description: 'Reduce image file size instantly (up to 90%) without losing quality. Compress JPG, PNG & WebP fast and free.',
        icon: Minimize2,
        category: 'most-used',
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    tools: [
      ...
      },
      {
        ...
        name: 'Add Watermark',
        description: 'Add a text watermark with custom position, opacity, and style.',
        icon: Stamp,
        category: 'basic-editing',
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: 'Increase image resolution about 2× with AI sharpening. Compress afterward if the file is large.',
        icon: ZoomIn,
        category: 'dpi-quality',
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    tools: [
      ...
      },
      {
        ...
        slug: 'svg-to-png',
        name: 'SVG to PNG',
        description: 'Convert vector SVG graphics into raster PNG images with transparency.',
        icon: ArrowLeftRight,
        category: 'convert',
        keywords: ['svg to png', 'convert svg', 'vector to raster', 'svg converter', 'svg to png online'],
        processing: 'server',
      },
      {
        id: 'svg-to-jpg',
        slug: 'svg-to-jpg',
        name: 'SVG to JPG',
        description: 'Convert SVG graphics into JPEG format quickly for web use.',
        icon: ArrowLeftRight,
        category: 'convert',
        keywords: ['svg to jpg', 'svg to jpeg', 'convert svg to jpg', 'vector to jpg'],
        processing: 'server',
      },
      {
        id: 'webp-to-png',
        slug: 'webp-to-png',
        name: 'WebP to PNG',
        description: 'Convert WebP images into universally compatible PNG files.',
        icon: ArrowLeftRight,
        category: 'convert',
        keywords: ['webp to png', 'convert webp', 'webp converter', 'webp to png online'],
        processing: 'server',
      },
      {
        id: 'image-to-text',
        ...
        description: 'Extract text from images using OCR. English plus common languages such as Spanish, French, German, Chinese, Japanese, Korean, Hindi, Arabic, and Russian.',
        icon: FileText,
        category: 'convert',
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: 'Resize a signature to print sizes such as 6×2 cm at 300 DPI, or a custom scale.',
        icon: Ruler,
        category: 'signature',
    ...
    tools: [
      {
        ...
        slug: 'compress-pdf',
        name: 'Compress PDF',
        description: 'Reduce PDF file size quickly without losing document quality. Fast, free, and secure PDF compression.',
        icon: FileMinus,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'merge-pdf',
        name: 'Merge PDF',
        description: 'Combine multiple PDF files into a single document instantly online. Drag and drop, no signup needed.',
        icon: Merge,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        name: 'PDF Watermark',
        description: 'Add a text stamp such as CONFIDENTIAL or DRAFT to every PDF page.',
        icon: Stamp,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'protect-pdf',
        name: 'Protect PDF',
        description: 'Protect PDF files with password-based encryption for secure sharing and access control.',
        icon: Shield,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'unlock-pdf',
        name: 'Unlock PDF',
        description: 'Remove a known password from encrypted PDF files and download an unlocked copy.',
        icon: FileLock,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        description: 'Insert page numbers into your PDF file. Choose position, font size, and format.',
        icon: Hash,
        category: 'pdf-tools',
        keywords: ['add page numbers', 'number pdf pages', 'insert page numbers', 'pdf bates numbering'],
        processing: 'server',
      },
      {
        id: 'pdf-sign',
        slug: 'sign-pdf',
        name: 'Sign PDF',
        description: 'Sign PDF documents online. Draw your signature, type with calligraphy fonts, or upload an image to sign contracts and agreements.',
        icon: FileSignature,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'redact-pdf',
        name: 'Redact PDF',
        description: 'Permanently black out sensitive text, SSNs, financial details, and confidential information in PDF documents.',
        icon: EyeOff,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'flatten-pdf',
        name: 'Flatten PDF',
        description: 'Flatten fillable PDF forms into read-only documents. Lock form fields, checkmarks, and signatures for court and government filing.',
        icon: Layers,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'crop-pdf',
        name: 'Crop PDF',
        description: 'Crop PDF pages to custom margins, trim white borders, or adjust dimensions for printing and mobile e-readers.',
        icon: Crop,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        description: 'Select and extract specific pages or page ranges from a PDF file into a new standalone document.',
        icon: Scissors,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'fill-pdf',
        name: 'Fill PDF Forms',
        description: 'Fill out PDF forms online. Type text, add checkmarks, insert date stamps, and complete contracts without printing.',
        icon: Pencil,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'grayscale-pdf',
        name: 'Grayscale PDF',
        description: 'Convert color PDF documents to monochrome black and white or grayscale to save printer ink and reduce file size.',
        icon: Contrast,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'pdf-to-text',
        name: 'PDF to Text',
        description: 'Extract clean selectable text from PDF documents. Copy to clipboard or export formatted text files instantly.',
        icon: FileText,
        category: 'pdf-tools',
      ...
      },
      {
        ...
        slug: 'pdf-to-pdfa',
        name: 'PDF to PDF/A',
        description: 'Convert standard PDF files to ISO-compliant PDF/A archival format for long-term archiving, legal submissions, and compliance.',
        icon: Shield,
        category: 'pdf-tools',
        keywords: ['pdf to pdfa', 'convert pdf to pdf/a', 'pdf a converter', 'pdf archival format', 'iso 19005', 'pdfa compliance'],
        badge: 'ISO',
        processing: 'server',
      },
      {
        ...
        slug: 'word-to-pdf',
        name: 'Word to PDF',
        description: 'Convert Microsoft Word documents (.docx) into professional, read-only PDF files with preserved formatting.',
        icon: FileText,
        category: 'pdf-tools',
        keywords: ['word to pdf', 'convert docx to pdf', 'doc to pdf', 'word document to pdf', 'convert word to pdf online', 'docx to pdf converter'],
        popular: true,
        badge: 'Popular',
        processing: 'server',
      },
      {
        ...
        slug: 'pdf-to-word',
        name: 'PDF to Word',
        description: 'Convert PDF files into editable Microsoft Word documents (.docx) with structured paragraphs and layout formatting.',
        icon: FileText,
        category: 'pdf-tools',
        keywords: ['pdf to word', 'convert pdf to docx', 'pdf to doc', 'edit pdf in word', 'pdf to word converter', 'pdf to editable word'],
        popular: true,
        badge: 'Popular',
        processing: 'server',
      },
      {
        ...
        slug: 'pdf-to-excel',
        name: 'PDF to Excel',
        description: 'Extract tables, rows, and financial data from PDF invoices and statements into Microsoft Excel (.xlsx) spreadsheets.',
        icon: FileSpreadsheet,
        category: 'pdf-tools',
        keywords: ['pdf to excel', 'convert pdf to xlsx', 'extract table from pdf', 'pdf to spreadsheet', 'pdf to csv', 'pdf to excel converter'],
        popular: true,
        badge: 'Popular',
        processing: 'server',
      },
